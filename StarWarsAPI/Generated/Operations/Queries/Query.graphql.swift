...
public class Query: GraphQLQuery {
  ...
  public struct Data: StarWarsAPI.SelectionSet {
    ...
    public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.Root }
    ...
    public struct AllFilms: StarWarsAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.FilmsConnection }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct Film: StarWarsAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.Film }
        public static var __selections: [Apollo.Selection] { [
        ...
        public struct SpeciesConnection: StarWarsAPI.SelectionSet {
          ...
          public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.FilmSpeciesConnection }
          public static var __selections: [Apollo.Selection] { [
          ...
          public struct Specy: StarWarsAPI.SelectionSet {
            ...
            public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.Species }
            public static var __selections: [Apollo.Selection] { [
            ...
            public struct Homeworld: StarWarsAPI.SelectionSet {
              ...
              public static var __parentType: Apollo.ParentType { StarWarsAPI.Objects.Planet }
              public static var __selections: [Apollo.Selection] { [
                .field("name", String?.self),
              ] }
